...
static const int64_t STATIC_POS_REWARD = 3.5 * COIN; //Constant reward of 3.5 NDOGE per COIN
static const int64_t TARGET_SPACING = 2 * 60; // 3 min per Block
static const int64_t TARGET_SPACING2 = 2 * 60; // 3 min per Block
...
static const int64_t MAX_MONEY = 60500000000 * COIN; // 100000 POW block
