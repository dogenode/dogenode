...
const string strMessageMagic = "DogeNode Signed Message:\n";
...
{
    // main collateral
    int64_t nCollateral = 250000;
	
    // new collateral STAGE1 after block 297777
    if (nHeight >= 297777)
    {
        // 500000 collateral
        nCollateral = 500000;
    }
	// new collateral STAGE2 after block 397777
    if (nHeight >= 397777)
    {
        // 1000000 collateral
        nCollateral = 1000000;
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1){
      ...
      nSubsidy = 312500000 * COIN;
	} else if (nHeight > 5 && nHeight <= 14){
      nSubsidy = 0.1 * COIN;
	} else if (nHeight == 15){
      nSubsidy = 20000000 * COIN;
	} else if (nHeight > 16 && nHeight <= 19){
      nSubsidy = 0.1 * COIN;
	} else if (nHeight == 20){
      nSubsidy = 2500000 * COIN;
	} else if (nHeight > 21 && nHeight <= 500){
      nSubsidy = 0.1 * COIN;
	} else if (nHeight > 500 && nHeight <= 100000){
      nSubsidy = 20 * COIN;
	}
...
{
    int64_t nSubsidy = 350;

    if(nBestHeight >= 1 && nBestHeight <= 1000){
      nSubsidy = 0.1 * COIN;
    } else if(nBestHeight >= 1000 && nBestHeight < 272222){
      nSubsidy = 5 * COIN;
    } else if(nBestHeight >= 272222 && nBestHeight < 300000){
      nSubsidy = 350 * COIN;
      ...
      nSubsidy = 2800 * COIN;
    } else if(nBestHeight >= 700000 && nBestHeight < 800000){
      nSubsidy = 2100 * COIN;
	} else if(nBestHeight >= 800000 && nBestHeight < 900000){
      nSubsidy = 1400 * COIN;
	} else if(nBestHeight >= 900000 && nBestHeight < 1000000){
      nSubsidy = 700 * COIN;
    } else{
      nSubsidy = 350 * COIN;
    }
...
// ----------- instantX transaction scanning -----------
    ...
    if(pindexBest->nHeight > 297727 && pindexBest->nHeight < 297827) MasternodePayments = false; 
    if(pindexBest->nHeight > 397727 && pindexBest->nHeight < 397827) MasternodePayments = false; // transition period
    if (!fIsInitialDownload)
    {
        if(MasternodePayments)
        {
            ...
            if(IsProofOfStake() && pindex != NULL){
                if(pindex->GetBlockHash() == hashPrevBlock){
                    ...
                    CDogeNodeAddress address2(address1);
